...
const Cart = () => {
  ...
  return (
    <>
      <div className={`fixed top-0 left-0 right-0 bottom-0 blur-effect-theme w-full h-screen opacity-100 z-[250] ${ifCartState ? "opactiy-100 visible translate-x-0" : "opacity-0 invisible translate-x-8"}`}>
            ...
            : <div>
                ...
                <div className='fixed bottom-0 bg-white w-full px-5 py-2 grid items-center'>
                  <div className='flex items-center justify-between'>
                    ...
                    <h1 className='text-sm rounded  bg-theme-cart text-slate-100 px-1 py-0.5'>4{totalAmount}</h1>
                  </div>
